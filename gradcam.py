...
loaded_model = tf.keras.models.load_model('CIFAKE_cnn.h5')
...
plt.savefig("CNN_images/GRADCAM HEATMAP.png")
plt.show()

#Super visualization
def save_and_display_gradcam(img_path, heatmap, cam_path="CNN_images/gradcam.jpg", alpha=0.4):
